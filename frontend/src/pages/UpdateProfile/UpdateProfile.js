...
import OkBox from "../../components/OkBox/OkBox";
...
const UpdateProfile = () => {
    ...
    const [showOkBox, setShowOkBox] = useState(false);
    ...
    const updatePasswordHandler = async (event) => {
        ...
        try {
            if (window.confirm("Voulez-vous vraiment modifier votre mot de passe ?")) {
                await sendRequest(
